...
const getCategoryProduct = async (req, res) => {
    try {
        const productCategory = await productModel.distinct("category"); // Get the category from product models
        ...
        res.status(200).json({
            ...
            data: productByCategory, // Send the list of products by category
            success: true,
            error: false
        });
